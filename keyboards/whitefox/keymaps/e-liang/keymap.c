...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN] = LAYOUT_truefox( \
      ...
      _______ , _______ , KC_BTN1 , KC_BTN2 , KC_BTN3 , _______ , _______ , KC_ACL0 , KC_UP   , KC_ACL1 , _______ , _______ , _______ , _______           , _______ , \
  ...
  [_FN2] = LAYOUT_truefox( \
      ...
      KC_CAPS , _______ , _______ , EL_VMBP , EL_VMBN , _______ , _______ , _______ , _______ , _______ , EL_VMBW , _______ , _______                     , KC_MNXT , \
