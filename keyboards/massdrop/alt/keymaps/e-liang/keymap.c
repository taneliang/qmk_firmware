...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_DEFAULT] = LAYOUT( \
    KC_GRV         , KC_1    , KC_2    , KC_3    , KC_4    , KC_5    , KC_6    , KC_7    , KC_8    , KC_9    , KC_0    , KC_LBRC , KC_RBRC , KC_BSLS , KC_PSCR , \
  ...
  [_FN2] = LAYOUT( \
    ...
    _______ , L_PSD   , L_BRI   , L_PSI   , L_T_BR  , _______ , _______ , _______ , KC_PGUP , _______ , _______ , _______ , _______ , _______ , _______ , \
    _______ , L_PTP   , L_BRD   , L_PTN   , L_T_PTD , _______ , _______ , KC_HOME , KC_PGDN , KC_END  , _______ , _______ , _______           , KC_MPLY , \
    _______           , L_T_MD  , L_T_ONF , _______ , _______ , MD_BOOT , NK_TOGG , _______ , _______ , _______ , _______ , _______ , KC_PGUP , KC_MUTE , \
